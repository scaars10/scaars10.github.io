...
This post explores the Low-Level Design (LLD) decisions behind an order execution and price treacking module. The goal was to create a codebase that is **clean, maintainable, and respectful of API boundaries** while handling the concurrency required for managing multiple positions.
